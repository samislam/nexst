...
runCommandsSequentially([
  new EchoCli({ message: chalk.bold.cyanBright.italic('~ Type checking your project...') }).command,
  ...
  new EchoCli({ message: chalk.greenBright('✔ No type errors were found') }).command,
  new EchoCli({ message: chalk.bold.cyanBright.italic('~ Eslint is checking project...') }).command,
